...
def scrape_rid():
    ...
    source = './../Resource/race-history.html'
...
def get_request_via_post(word):
    ...
    with urllib.request.urlopen(url, data=_param.encode('utf8')) as res:
...
def main():
    ...
    rid_list = scrape_race_id(source)
